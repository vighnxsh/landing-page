...
export const Checklist: React.FC<ChecklistProps> = ({ className }) => {
  return (
    <div className={cn('flex flex-col gap-2  rounded-lg p-2', className)}>
  ...
  return (
    <div className="flex justify-between gap-1">
      <HoverPopover root={true}>
        <HoverPopoverTrigger>
          <div className="truncate text-3xl text-pink-500  group-hover:decoration-neutral-200">
            {`Top 10 Holders`}
          </div>
        </HoverPopoverTrigger>
        <HoverPopoverContent>
      ...
      <div
        className={cn(
          'inline-flex items-center text-pink-500 text-xl',
...
const ChecklistAuthority: React.FC = () => {
  ...
  return (
    <div className="flex justify-between gap-1">
      <HoverPopover root={true}>
        <HoverPopoverTrigger>
          <div className="truncate text-lg text-neutral-500 underline decoration-neutral-700 decoration-dashed underline-offset-4 group-hover:decoration-neutral-200">
            Mint / Freeze
          </div>
        </HoverPopoverTrigger>
