...
export default class LoadingScene extends Scene {
  ...
  preload() {
    // Skip bitmap font for now since it's causing issues
    // We'll use regular text instead
  ...
  create() {
    ...
    let centerY = this.cameras.main.centerY;
            ...
            // Use regular text instead of bitmap text for now
            this.add
              .text(centerX, centerY - 12, "Loading...", {
                fontSize: '8px',
                color: '#ffffff',
                fontFamily: 'Arial'
              })
  ...
  init() {
    ...
    this.load.on("complete", () => {
      console.log("Loading complete, checking loaded textures:");
